...
/*Создайте переменные $a=10 и $b=2. Выведите на экран
их сумму, разность, произведение и частное (результат деления).*/
$a = 10;
$b = 2;
echo $a + $b;
echo $a - $b;
...
$num = '12345';
$num_sum = $num[0]+$num[1]+$num[2]+$num[3]+$num[4];
echo $num_sum;
...
Возведите это число в квадрат (это значит нужно умножить
его само на себя). Выведите его на экран.*/
$number = 25;
$sqr = $number*$number;
echo $sqr;
